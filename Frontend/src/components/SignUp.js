        ...
        <div>
          ...
          >
            Login with Facebook
             ...
             <SocialButton
              provider="google"
              appId="7275423793-monpcv690iv00a6dk659hpdb07vo85kf.apps.googleusercontent.com"
              onLoginSuccess={handleSocialLogin}
              onLoginFailure={handleSocialLoginFailure}
            >
              Login with gmail
          ...
          <center><img src={"images/m2.jpeg"} style={{height:"250px",width:"50%"}}/></center>

          <form method="post" onSubmit={submit}>
            <div class="txt">
              <input type="text" placeholder="Enter Name" name='name' required ref={NameInput} onChange={handler} />
              <span></span>
            </div>
